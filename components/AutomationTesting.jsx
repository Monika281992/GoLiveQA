...
const playwrightChecklist = [
  ...
  "Need mobile-web emulation",
  "Large scale test suite with 500+ cases",
];

const cypressChecklist = [
  "Component testing for React, Vue and Angular",
  "Live time-travel debugging while writing tests",
  "Easier onboarding for teams new to automation",
  "Already Invested in Cypress",
  "Small scale test suite with 200+",
];
...
const includedCards = [
  {
    ...
    text: "We build automation in the framework that fits your stack, with clean and readable tests your team can maintain.",
  },
  {
    Icon: Infinity,
    title: "CI/CD Integration",
    text: "Tests run automatically every day via scheduled jobs — catching regressions before your users do.",
  },
  {
    Icon: FileSearch2,
    title: "Customize Report",
    text: "A detailed test report is generated after every run and sent directly to your team's messaging app.",
  },
];
...
export function AutomationTesting() {
  return (
    <div className="min-h-screen bg-surface">
      ...
      {/* CTA */}
      <CTAEmailCapture
        heading="Ready to automate your regression?"
        subtext="Tell us about your product and we'll scope the right automation suite — in Playwright or Cypress."
      />
