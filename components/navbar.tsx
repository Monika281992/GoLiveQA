                  ...
                  {[
                    ...
                    card.disabled ? (
                      <div key={card.title} className="relative flex items-start gap-3 rounded-[10px] border border-hairline bg-white p-4 shadow-sm opacity-60 cursor-not-allowed">
                        <span className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-full bg-[#dff3e4] px-2 py-0.5 text-[10px] font-600 text-[#2f8a4e]">
                          Coming soon
                        </span>
                        <span className="mt-0.5 text-[1.5rem] leading-none grayscale">{card.icon}</span>
                        <div>
