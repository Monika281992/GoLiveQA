...
export const metadata = {
  title: "Quality Engineering — GoLiveQA",
  description: "Enterprise-grade quality engineering for resilient, scalable software.",
};

const highlights = [
  "Shift-left testing integrated into development",
  "Test strategy and QA process design",
  "Release management across multiple teams",
  "Zero critical escapes in production",
  "Quality metrics and reporting dashboards",
  "Full ownership of your product quality lifecycle",
];
      ...
      <main>
        ...
        <section className="relative overflow-hidden py-16 md:py-24 lg:py-[108px]">
          ...
          <div className="relative mx-auto max-w-[760px] px-5 text-center sm:px-8 lg:px-12">
            ...
            <p className="mx-auto mt-5 max-w-[580px] text-[1.1rem] leading-relaxed text-muted">
              Deliver resilient, scalable software through enterprise-grade quality engineering — built around your team and roadmap.
            </p>
          ...
          <div className="mx-auto max-w-container px-5 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-[560px] text-center">
              ...
              <p className="mt-3 text-[1rem] leading-relaxed text-muted">
                A complete quality engineering practice tailored to your product and team.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-container px-5 text-center sm:px-8 lg:px-12">
            <h2 className="text-[clamp(1.8rem,3.5vw,2.4rem)] font-bold tracking-[-0.025em] text-ink">
              Ready to build quality into every release?
            </h2>
            <p className="mt-3 text-[1rem] text-muted">
              Let&apos;s design a QA strategy that scales with your team.
            </p>
