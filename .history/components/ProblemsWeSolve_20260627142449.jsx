    ...
    items: [
      {
        ...
        desc:  "Our QA team involves at the requirements stage — understanding which end user problem we are solving, reviewing designs, and flagging gaps before a single line of code is written.",
        dark: false,
      },
      {
        n: 2, Icon: UsersRound,
        title: "Adding Acceptance Criteria",
        desc:  "We map out every way a feature could break in the real world — long before it ever reaches your users.",
        dark: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc:  "Once built, we test every path a user could take — ensuring it works exactly as intended, every time.",
        dark: false,
      },
      {
      ...
      },
      {
        ...
        desc:  "Every new release is checked to make sure it hasn't broken anything that was already working in production.",
        dark: false,
      },
    ],
  },
