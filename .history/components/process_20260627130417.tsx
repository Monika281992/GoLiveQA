...
export function Process() {
  return (
    <section
      id="process"
      className="bg-surface py-16 md:py-24 lg:py-[108px]"
    >
      <div className="mx-auto max-w-container px-5 sm:px-8 lg:px-12">
        <div className="mx-auto mb-14 max-w-[200px]">
