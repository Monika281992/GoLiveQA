      ...
      <nav className="mx-auto flex max-w-container items-center justify-between gap-4 px-5 py-3.5 sm:px-8 lg:px-12">
        ...
        <div className="hidden items-center gap-7 md:flex">
          ...
          <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            ...
            {dropdownOpen && (
              <div className="absolute left-1/2 top-full mt-2 w-[920px] -translate-x-1/2 rounded-[18px] border border-hairline bg-white p-6 shadow-lift">
                    ...
                    <div key={card.title} className="flex items-start gap-3 rounded-[10px] bg-white p-4 shadow-sm">
                      ...
                      <div>
                        <a href="#services" onClick={closeAll}
                          className="mb-1 block text-[13.5px] font-semibold text-ink underline underline-offset-2 hover:text-accent">
                          {card.title}
                        </a>
                        <p className="text-[12px] leading-snug text-muted">{card.text}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-4 gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      {focusAreas.map((item) => (
                        <span key={item} className="text-[13.5px] text-body">{item}</span>
                      ))}
                    </div>
                  </div>
                  {/* Col 3 */}
