              ...
              <div className="absolute left-1/2 top-full mt-2 w-[1100px] -translate-x-1/2 rounded-[18px] border border-hairline bg-white p-6 shadow-lift">
                ...
                <div className="mb-5 grid grid-cols-3 gap-3">
                  {[
                    ...
                    { icon: "🤖", title: "Automation Coverage", href: "#services", text: "Establish consistent, high-performance automation frameworks for dependable releases." },
                    { icon: "⚙️", title: "Quality Engineering", href: "#services", text: "Deliver resilient, scalable software through enterprise-grade quality engineering." },
                  ].map((card) => (
                    <div key={card.title} className="flex items-start gap-3 rounded-[10px] border border-hairline bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:border-accent/30 hover:shadow-lift">
                      <span className="mt-0.5 text-[1.5rem] leading-none">{card.icon}</span>
                      <div>
                        <a href={card.href} onClick={closeAll}
              ...
              {mobileServicesOpen && (
                <div className="mb-2 mt-1 flex flex-col gap-3 rounded-[12px] border border-hairline bg-surface-soft p-4">
                  {[
                    ...
                    { icon: "🤖", title: "Automation Coverage", href: "#services" },
                    { icon: "⚙️", title: "Quality Engineering", href: "#services" },
                  ].map((card) => (
