          ...
          {phases.map((phase, phaseIdx) => (
            <div key={phase.label}>
              ...
              {phase.items.map((item) => {
                ...
                return (
                  <div key={item.n} style={{ display: "flex", gap: 28, alignItems: "flex-start", marginBottom: 16, opacity: isDisabled ? 0.45 : 1, filter: isDisabled ? "grayscale(1)" : "none", position: "relative" }}
                    title={isDisabled ? "Upgrade to Automation to include this" : undefined}>
