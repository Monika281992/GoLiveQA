...
const navLinks = ["About", "Process", "Contact"];
const footerLinks = ["About", "How Can I Help", "Process", "Contact"];
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#faf6ef", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <a href="/" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: 20, color: "#1a1a1a", textDecoration: "none" }}>
          GoLiveQA
        </a>
        <div style={{ display: "flex", alignItems: "center", gap: 28, flexWrap: "wrap" }}>
          {navLinks.map((link) => (
            <a key={link} href={`/#${link.toLowerCase()}`} style={{ fontSize: 15, color: "#1a1a1a", textDecoration: "none" }}>
              {link}
            </a>
          ))}
          <a href="#" style={{ fontSize: 15, color: "#c0552f", textDecoration: "none", display: "flex", alignItems: "center", gap: 4 }}>
      ...
      {/* Hero */}
      <section style={{ background: "#e8dcc6", padding: "92px 32px 84px" }}>
      ...
      <footer style={{
        ...
        <a href="/" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: 17, color: "#0450d4", textDecoration: "none" }}>
          GoLiveQA
        </a>
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
          {footerLinks.map((link) => (
            <a key={link} href="#" style={{ fontSize: 14, color: "#7a6f62", textDecoration: "none" }}>{link}</a>
          ))}
        </div>
        <span style={{ fontSize: 13, color: "#9a8f80" }}>© 2026 GoLiveQA. All rights reserved. A boutique QA consultancy.</span>
      </footer>
