            ...
            {dropdownOpen && (
              <div className="absolute left-1/2 top-full mt-2 w-[920px] -translate-x-1/2 rounded-[18px] border border-hairline bg-white p-6 shadow-lift">
                ...
                <div className="grid grid-cols-4 gap-6">
                  {/* Col 1 */}
                  <div>
                    <p className="mb-3 text-[12px] font-bold uppercase tracking-[0.08em] text-muted">Engagement Models</p>
                    <div className="flex flex-col gap-3">
                      {engagementModels.map((item) => (
                        <div key={item.title}>
                          <p className="text-[15px] font-semibold text-ink">{item.title}</p>
                          <p className="text-[13px] leading-snug text-muted">{item.desc}</p>
                        </div>
                      ))}
                    </div>
                  </div>
