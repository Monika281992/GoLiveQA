...
const focusAreas = [
  { label: "Web App Testing", icon: Globe },
  { label: "Mobile App Testing", icon: Smartphone },
  { label: "API Testing", icon: Webhook },
  { label: "Desktop App Testing", icon: Monitor },
  { label: "Dashboard Testing", icon: LayoutDashboard },
  { label: "Cross-Platform Testing", icon: Layers },
];

const testingCoverage = [
  { label: "Regression Testing", icon: RefreshCw },
  { label: "Functional Testing", icon: CheckCircle2 },
  { label: "Integration Testing", icon: GitMerge },
  { label: "End-to-End Testing", icon: Workflow },
  { label: "Performance Testing", icon: Zap },
  { label: "Compatibility Testing", icon: MonitorSmartphone },
];

const frameworks = [
  { label: "Playwright", icon: Code2 },
  { label: "Cypress", icon: FileCode },
  { label: "Selenium", icon: Terminal },
  { label: "Appium", icon: Smartphone },
  { label: "Postman", icon: Send },
  { label: "k6", icon: Activity },
];
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      {focusAreas.map(({ label, icon: Icon }) => (
                        <span key={label} className="flex items-center gap-2 text-[15px] text-body">
                          <Icon className="h-[14px] w-[14px] flex-none text-accent" />{label}
                        </span>
                      ))}
                    </div>
                  </div>
